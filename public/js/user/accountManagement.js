...
{
   // alert(id);
	document.getElementById('activeStatus_'+id).innerHTML = "<i class='fa fa-spinner fa-spin fa-2x'></i>";
    $.ajax({
        type: 'POST',
...
{
  //  alert(id)
  document.getElementById('activeStatus_'+id).innerHTML = "<span style='color: darkgreen'><i class='fa fa-spinner fa-spin fa-2x'></i></span>";
