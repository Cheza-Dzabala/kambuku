                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form method="POST" action="{{ route('admin.updateWords') }}">
                                {!! csrf_field() !!}
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input class="form-control" name="filter_name" value="{{ $filter->filter_name }}" required>
                                </div>

                                <div class="form-group col-md-8">
                                    <label for="words">Words</label>&nbsp;<small>E.g: Separate Words By Commas</small>
                                    <textarea class="form-control" cols="10" rows="10" name="words" required>{{ $filter->words }}</textarea>
                                </div>

                                <div class="form-group col-md-8">
                                    <input type="checkbox" name="is_active" @if($filter->is_active == '1') checked @endif> Active Status
                                    <br/>
                                    <br/>
