                    ...
                    <ul>
                        <li class="dropdown" style="list-style: none">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                           <span class="panel-title"><h4>Moderate Ticket With Code {{ $code }}
                                               </h4>
                                               </span>
                            </a>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive">
                                <form action="{{ route('admin.tickets.saveModeration')  }}" method="post">
                                    <input type="hidden" value="{{ $code }}" name="code">
                                    <input type="hidden" value="{{ $type }}" name="type">
                                        <div class="form-group">
                                            <input type="radio" name="isActive" value="0" @if($activeStatus == 0) checked @endif> Inactive
                                            <br/>
                                            <input type="radio" name="isActive" value="1" @if($activeStatus == 1) checked @endif> Active
                                        </div>
