                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group{{ $errors->has('client_phoneNumber') ? ' has-error' : '' }}  col-md-8">
                                    <input type="text" class="form-control" name="client_phoneNumber" placeholder="Client Phone Number" required>
                                ...
                                <div class="form-group{{ $errors->has('client_phonenumber2') ? ' has-error' : '' }}  col-md-8">
                                    <input type="text" class="form-control" name="client_phonenumber2" placeholder="Client Phone Number 2 (Optional)">
                                ...
                                <div class="form-group{{ $errors->has('client_address') ? ' has-error' : '' }}  col-md-8">
                                    <textarea rows="10" name="client_address" class="form-control" placeholder="Client Address" required></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group{{ $errors->has('ad_name') ? ' has-error' : '' }}  col-md-8">
                                    <input type="text" class="form-control" name="ad_name" placeholder="Advert Name" required>
