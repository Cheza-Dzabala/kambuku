                    ...
                    <ul>
                        <li class="dropdown" style="list-style: none">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                           <span class="panel-title"><h4>New Content Page For {{ $header->title }}
                                                 </h4>
                                               </span>
                            </a>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form method="post" action="{{ route('admin.saveContentPage') }}">
                                {!! csrf_field() !!}
                                <div class="row col-md-8">
                                    <input type="hidden" value="{{ $header->id }}" name="header_id">
